 ...
 */
function msgweb_breadcrumb($variables) {
 ...
 */
function msgweb_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // msgweb_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  msgweb_preprocess_html($vars);
}
 ...
 */
function msgweb_preprocess_node(&$vars) {
 ...
 */
function msgweb_preprocess_comment(&$vars) {
 ...
 */
function msgweb_preprocess_block(&$vars) {
 ...
 * Override or insert variables into the page template.
 */
function msgweb_process_page(&$vars) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function msgweb_preprocess_region(&$vars) {
